...
public class Main {
	...
	// write your code here
        ...
        hp.setDocumento(0, new Documento("TRABAJO", "WORD", 10, 500));

        //DISPOSITIVO PENDRIVE CON 3 DOCUMENTOS EN SU MEMORIA
        Dispositivo pendrive = new Dispositivo("PENDRIVE", 8000000, false);
        pendrive.setDocumento(0, new Documento("CALCULO", "XLSX", 1, 343));
        pendrive.setDocumento(1, new Documento("LIBRO", "PDF", 200, 3000));
        pendrive.setDocumento(2, new Documento("PRESENTACION", "PPTX", 15, 1000));
